...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = ShaderDemo)
	class UTextureRenderTarget2D* GPUMeshRenderTarget;

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = ShaderDemo)
	class UVolumeTexture* GPUMeshSDFTexture;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = ShaderDemo)
	FIntVector SDFTextureSize = FIntVector(128,128,128);
//Debug
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = ShaderDemo)
	float DebugMeshRadius = 10.0f;
public:
